              ...
              <AnimatePresence>
                {data?.products.map((product: Product) => (
                  <motion.div
                    ...
                    className="bg-gray-800/50 backdrop-blur-sm rounded-xl p-3 sm:p-4 shadow-xl w-full"
                  >
                    <div className="flex flex-col sm:flex-row items-start justify-between gap-3 sm:gap-4">
                      <div className="flex items-center gap-3 sm:gap-4 flex-1 min-w-0">
                        <motion.div className="relative flex-shrink-0" whileHover={{ scale: 1.05 }}>
                          <img
                            className="h-12 w-12 sm:h-14 sm:w-14 rounded-lg object-cover border-2 border-gray-600/30"
                            src={product.images[0] as string}
                            alt={product.title}
                          />
                          {product.isFeatured && (
                        ...
                        <div className="min-w-0 flex-1">
                          ...
                          <span className="text-xs text-purple-300 bg-purple-500/20 px-2 py-1 rounded-full mt-1 inline-block">
                            {product.category}
                          </span>
                        </div>
