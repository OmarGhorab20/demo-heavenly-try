...
console.log("Sending order email from:", transporter.options.auth.user);
...
const EmailTemplates = {
    ...
    <html>
      ...
      <body>
        <div class="email-container">
          <div class="header">
            <img class="logo" src="https://res.cloudinary.com/my-e-commerce-cloud/image/upload/v1740988110/defaults/logo.webp"
              alt="Heavenly"
  ...
  verification: (verificationLink) => ({
    ...
    `,
    button: { text: 'Verify Email', link: verificationLink }
  }),
